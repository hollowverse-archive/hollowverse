 ...
 * [Colllector ID](https://help.sumologic.com/Start-Here/02Getting-Started/Glossary#section_2)
 * used to instantiate a `SumoLogger` instance on the server, to send logs to
