...
const singleActionReducers = {
  ...
  [ActionTypes.setEmailHasBlur]: createSingleActionSimpleReducer<boolean>('emailHasBlur'),
  [ActionTypes.setNameHasBlur]: createSingleActionSimpleReducer<boolean>('nameHasBlur'),
  [ActionTypes.setMessageHasBlur]: createSingleActionSimpleReducer<boolean>('messageHasBlur'),
  [ActionTypes.setEmailInputValue]: createSingleActionSimpleReducer<string>('emailInputValue'),
  [ActionTypes.setNameInputValue]: createSingleActionSimpleReducer<string>('nameInputValue'),
  [ActionTypes.setMessageInputValue]: createSingleActionSimpleReducer<string>('messageInputValue'),
  [ActionTypes.setIsSubmitPending]: createSingleActionSimpleReducer<boolean>('isSubmitPending'),
  [ActionTypes.setSubmitSuccess]: createSingleActionSimpleReducer<boolean>('submitSuccess'),
  [ActionTypes.setSubmitFail]: createSingleActionSimpleReducer<boolean>('submitFail'),
